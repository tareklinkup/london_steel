...
class Customer extends CI_Controller
{
    ...
    public function addCustomer()
    {
        ...
        try{
            ...
            $customerMobileCount = $this->db->query("select * from tbl_customer where Customer_Type = 'retail' and Customer_Mobile = ? and Customer_brunchid = ? ", [$customerObj->Customer_Mobile, $this->session->userdata("BRANCHid")])->num_rows();
            if($customerMobileCount > 0){
                $res = ['success'=>false, 'message'=>'Mobile number already exists in this Branch'];
                echo Json_encode($res);
                exit;
            }
