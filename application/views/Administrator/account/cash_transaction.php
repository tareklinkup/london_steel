					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<input type="number" class="form-control" required v-model="transaction.Commission" v-if="transaction.Tr_Type == 'commission'" v-bind:style="{display: transaction.Tr_Type == 'commission' ? '' : 'none'}">
							</div>
						</div>
						<div class="form-group">
