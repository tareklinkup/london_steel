				...
				<div class="row">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<v-select v-bind:options="suppliers" v-model="selectedSupplier" label="display_name"
									v-on:input="getSupplierDue" v-if="suppliers.length > 0"></v-select>
							</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="date" class="form-control" v-model="payment.SPayment_date" required
									v-on:change="getSupplierPayments" :readonly="userType == 'u'">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control" step="0.01" v-model="payment.SPayment_amount"
									required>
							</div>
						</div>
						<div class="form-group">
					...
					<template scope="{ row }">
						<tr>
							...
							<td>
								...
								<button type="button" class="button edit" v-on:click="editPayment(row)">
									<i class="fa fa-pencil"></i>
								</button>
								<button type="button" class="button" v-on:click="deletePayment(row.SPayment_id)">
