						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<v-select v-bind:options="customers" v-model="selectedCustomer" label="display_name"
									v-on:input="getCustomerDue" v-if="customers.length > 0"></v-select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="date" class="form-control" v-model="payment.CPayment_date" required
									v-on:change="getCustomerPayments" :readonly="userType == 'u'">
							</div>
						</div>
						<div class="form-group">
						...
						<tr>
							...
							<td>
								<button type="button" class="button edit"
									v-on:click="window.location = `/paymentAndReport/${row.CPayment_id}`">
								...
								<button type="button" class="button" v-on:click="deletePayment(row.CPayment_id)">
