...
$route['students_list'] = 'Administrator/App/student_list';
$route['auth'] = 'Administrator/App/auth';
$route['student_acc_create'] = 'Administrator/App/student_acc_create';
...
$route['lotstock'] = 'Administrator/Products/lot_stock';
$route['lot_stock_view'] = 'Administrator/Products/lot_stock_view';
...
$route['get_avarage_purchase_rate']	=	'Administrator/Products/getAvaragePurchaseRate';
...
$route['delete_sold_product'] = 'Administrator/Sales/deleteSoldProduct';
