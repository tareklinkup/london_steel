                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr v-if="sales.deliveryCost > 0">
                                <td><strong>Delivery Cost:</strong></td>
                                <td style="text-align:right">{{ sales.deliveryCost }}</td>
                            </tr>
        ...
        printWindow.document.write(`
                    ...
                    <body>
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="border-bottom:1px solid #ccc;margin-bottom:5px;padding-bottom:6px;margin-top:10px;position:fixed;bottom:0px;width:100%">
                            <div class="col-xs-6"> 
                                <span style="text-decoration:overline;margin-left:15px">Received by</span><br><br>
